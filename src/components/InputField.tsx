...
const InputField: React.FC<InputProps> = ({ todo, setTodo, handleAdd }) => {
	...
	return (
		...
		>
			...
			<button
				type='submit'
				className='absolute size-14 m-2 rounded-full text-lg right-0 text-white transition-all duration-150 shadow-custom-lg bg-[#2f74c0] hover:bg-[#388ae2] active:scale-75 active:shadow-custom-md'
			>
				Go
			</button>
		</form>
